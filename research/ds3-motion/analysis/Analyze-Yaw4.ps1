# Reproduces docs/MOTION.md yaw sign + ~1.4 counts/(deg/s) scale.
# Throwaway: yaw sign + scale, final method.
#  * phase blocks split on >150 ms gaps; six 2.5 s orientation blocks then the 5 s yaw block
